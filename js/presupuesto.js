function init(){
    ...
    //Realizando los calculos para distribucion del presupuesto
    derma = presupuesto*0.40;
    trauma = presupuesto*0.35;
    pedia = presupuesto*0.25;

    //creando el codigo que se insertara dentro del elemento div id=dristribucion
    var html = "<ul>\n\t<li>\n";
    ...
    //Insertando dentro del elemento div el codigo asignado en la variable html
    div.innerHTML = html;
